...
class Profile(models.Model):
    ...
    msg_counter = models.IntegerField(default = 0, blank = True)
    notif_counter = models.IntegerField(default = 0, blank = True)
    new_followers = models.ManyToManyField(User, related_name = "new", blank = True)
